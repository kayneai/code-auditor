...
fn default_output() -> String {
    "code_audit_report.md".to_string()
}
...
impl Config {
    ...
    pub fn load_default() -> Result<Option<Self>> {
        let default_path = Path::new(".code-auditor.toml");
    ...
    pub fn load_from_repo(repo_path: &Path) -> Result<Option<Self>> {
        let config_path = repo_path.join(".code-auditor.toml");
    ...
    pub fn merge_with_args(&mut self, args: &crate::cli::Args) {
        ...
        if (args.temperature - 0.1).abs() > f32::EPSILON {
